                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Cadastros de Cidades</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="table-responsive mailbox-messages">
                                    ...
                                    <div class="card card-default">
                                        <div class="card-header">
                                            <h3 class="card-title">Cadastros de Cidades</h3>
                                            <!-- botões topo de salvamento de arquivos -->

                                            <div class="card-tools">

                                                <button type="button" class="btn btn-dark btn-sm mr-1" data-toggle="tooltip" title="Imprimir">
                                                        <i class="fas fa-print"></i>
                                                    </button>

                                                <button type="button" class="btn btn-info btn-sm mr-1" data-toggle="tooltip" title="Exportar para Excel">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-6 col-md-10 col-lg-12">
                                                    <div class="card ">
                                                        <!-- busca avançada no topo da pagina -->
                                                        <div class="card-header border-0 p-1">
                                                            <h3 class="card-title mb-1"><button type="button" class="btn btn-primary mr-1" data-toggle="modal" data-target="#modal-xl">
                                                                        Busca Avançada
                                                                      </button></h3>
                                                            ...
                                                            <!-- inicio tabela no conteudo da pagina -->
                                                            ...
                                                            <!-- fim inicio tabela no conteudo da pagina -->
                                                            <!-- paginação  -->
                                                        ...
                                                        <!-- fim busca avançada no topo da pagina -->


                                                    </div>
                                                    <!-- /.card -->

                                                    <!-- /modal buttao da busca avançada -->
                                                    <div class="modal fade" id="modal-xl">
                                                        <div class="modal-dialog modal-xl">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Campos a Pesquisar</h4>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                      </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4 col-md-8">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="custom-control custom-checkbox">
                                                                                            ...
                                                                                            <label for="customCheckbox1" class="custom-control-label">E</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox">
                                                                                            <input class="custom-control-input" type="checkbox" id="customCheckbox2">
                                                                                            <label for="customCheckbox2" class="custom-control-label">OU</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="custom-select">
                                                                                                ...
                                                                                                <option>Iniciado por</option>
                                                                                                <option>Terminado com</option>
                                                                                                <option>Diferente de</option>
                                                                                                <option>Não Contém</option>
                                                                                                <option>Não Iniciado por</option>
                                                                                                <option>Não Terminado com</option>
                                                                                            </select>
                                                                            </div>

                                                                        </div>
                                                                        <!-- /.modal -->
                                                                        <!-- campo operação select crescente e desc -->
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group">
                                                                                <label>Operação</label>
                                                                                <select class="custom-select">
                                                                        ...
                                                                        <!-- fim campo operação select crescente e desc -->
                                                                        <!-- inicio campos da tabela -->
                                                                        <div class="col-sm-12 col-md-12">
                                                                            <div class="row">

                                                                                <label>Campos da tabela</label>
                                                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox3">
                                                                                        <label for="customCheckbox3" class="custom-control-label">Marcar / Desmarcar Todos</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox4">
                                                                                        <label for="customCheckbox4" class="custom-control-label">Código</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox5">
                                                                                        <label for="customCheckbox5" class="custom-control-label">País</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox6">
                                                                                        <label for="customCheckbox6" class="custom-control-label">Nome</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox7">
                                                                                        <label for="customCheckbox7" class="custom-control-label">Situação</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox8">
                                                                                        <label for="customCheckbox8" class="custom-control-label">Estado</label>
                                                                                    </div>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox9">
                                                                                        <label for="customCheckbox9" class="custom-control-label">Gentílico</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <!-- fim campos da tabela -->

                                                                        <!-- /.row -->
                                                                        <!-- botões de salvar , fechar e voltar -->
                                                                        <div class="modal-footer justify-content-between">
                                                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
                                                                            <button type="button" class="btn btn-primary">Salvar</button>
                                                                            <button type="button" class="btn btn-warning">Voltar</button>
                                                                        ...
                                                                        <!-- fim botões de salvar, fechar e voltar -->
                                ...
                                <ul class="nav nav-pills flex-column">
                                    <li class="nav-item active">
                                        <a href="#" class="nav-link">
                                            <i class="fas fa-play"></i> Link de exemplo
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">
